...
class MainViewController: UICollectionViewController {
    ...
    private func showAlert() {
        ...
        let cancel = UIAlertAction(title: "Cancel", style: .destructive){ [dataProvider] action in
        ...
        present(alert, animated: true){
            ...
            let progressView = UIProgressView(frame: CGRect(x: 0, y: self.alert.view.frame.height - 44, width: self.alert.view.frame.width, height: 10))
